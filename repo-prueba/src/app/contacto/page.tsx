      ...
      <main className="flex-grow">
        <div className="flex flex-col pt-[100px] gap-[40px] lg:flex-row lg:items-start lg:ml-[60px] lg:pt-[180px] lg:gap-[60px] xl:ml-[110px] 2xl:ml-[15%] 2xl:pt-[260px]">
          ...
          <div className="w-full max-w-[640px] lg:w-[500px] 2xl:w-[1100px] px-4">
            <h1 className="text-black font-light text-[32px] leading-[36px] w-full mt-[50px] mb-[30px] lg:text-[48px] lg:leading-[53px] lg:mb-[40px] lg:mt-[12px] 2xl:text-[80px] 2xl:leading-[80px] 2xl:mb-[94px] 2xl:mt-[10px]">
              Iniciemos tu <br className="2xl:hidden" />
              <span className="hidden 2xl:inline"> </span>
              liderazgo digital
            </h1>

            <h2 className="text-[#D81FB9] text-[24px] leading-[24px] font-semibold w-fit mt-[20px] lg:w-[351px] lg:text-[48px] lg:leading-[53px] lg:font-normal lg:mt-[30px] 2xl:text-[48px] 2xl:leading-[48px] 2xl:font-normal">
              Contáctanos
            </h2>
            ...
            <form className="mt-[22px] flex flex-col space-y-[18px]">
              ...
              {/* Checkbox Area */}
              <div className="w-full border border-[#707070] rounded-[5px] pt-[18px] pl-6 space-y-4 bg-white h-[320px] lg:h-[340px] lg:w-[605px] 2xl:w-[638px]">
          ...
          {/* Right Column */}
          <div className="flex flex-col lg:translate-x-[80px] xl:translate-x-[120px] 2xl:translate-x-[200px]">
            <div className="hidden lg:block relative lg:w-[400px] lg:h-[400px] lg:ml-[20px] xl:w-[700px] 2xl:h-[700px] 2xl:ml-[-41%]">
              <Image
                ...
                width={700}
                height={700}
                className="absolute top-[45%] lg:top-[87%] lg:left-[55%] xl:left-[65%] 2xl:top-[69%] 2xl:left-[90%] z-0 transform -translate-x-[65%] -translate-y-1/2 object-cover rounded-full lg:w-[360px] lg:h-[320px] xl:h-[450px] xl:w-[450px] 2xl:w-[680px] 2xl:h-[680px]"
              />
              <Image
                ...
                width={505}
                height={505}
                className="absolute top-[45%] lg:top-[87%] lg:left-[53%] xl:left-[63%] 2xl:top-[69%] 2xl:left-[88%] z-10 transform -translate-x-[65%] -translate-y-1/2 xl:h-[350px] xl:w-[350px] 2xl:w-[520px] 2xl:h-[520px] lg:w-[300px] lg:h-[300px] animate-spin [animation-direction:reverse] [animation-duration:120s]"
              />
            </div>

            <div className="mt-0 w-full max-w-[640px] mb-14 px-4 flex flex-col items-start lg:mt-[405px] lg:ml-8 xl:ml-[100px] 2xl:ml-[120px] 2xl:mt-[240px] lg:px-0">
