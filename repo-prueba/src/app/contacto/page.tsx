        ...
        <div className="flex flex-col pt-[100px] gap-[40px] lg:flex-row lg:items-start lg:ml-[60px] lg:pt-[180px] lg:gap-[60px] xl:ml-[110px] 2xl:ml-[15%] 2xl:pt-[260px]">
          ...
          <div className="w-full lg:basis-[60%] lg:flex-grow 2xl:basis-[70%] 2xl:max-w-none px-4">
            <div className="flex flex-col space-y-[30px] lg:space-y-[100px]">
              <h1 className="mt-[40px] lg:mt-[4px] w-full break-words text-black font-light text-[32px] leading-[36px] lg:text-[70px] lg:leading-[70px] 2xl:text-[80px] 2xl:leading-[80px] 2xl:font-normal">
                <span>Iniciemos tu</span>
                <span className="block lg:inline"> liderazgo digital</span>
              </h1>
              <h2 className="text-[#D81FB9] text-[24px] leading-[24px] font-normal w-fit lg:w-[351px] lg:text-[48px] lg:leading-[53px] 2xl:text-[48px] 2xl:leading-[48px]">
                Contáctanos
              </h2>
            </div>
            ...
            <form className="mt-[22px] flex flex-col space-y-[20px]">
              ...
              <div className="w-full min-h-[340px] border border-[#707070] rounded-[5px] pt-[18px] pl-6 pb-6 lg:space-y-8 space-y-6 bg-white lg:min-h-[280px] 2xl:min-h-[344px] lg:w-[605px] 2xl:w-[638px] 2xl:mt-[30px]">
                <p className="text-[16px] font-medium text-black mb-[26px] leading-[24px] max-sm:text-[18px]">
          ...
          {/* Right Column - Imagen + Red */}
          <div className="relative mt-[60px] lg:mt-[100px] flex-shrink-0">
            {/* Red (fondo) */}
            <div
              className="
                ...
                lg:translate-x-[-60%] lg:translate-y-[-50%]
                2xl:translate-x-[-65%] 2xl:translate-y-[-55%]
              "
            >
              <Image
                src="/red.png"
            ...
            <div
              className="
                ...
                2xl:w-[510px] 2xl:h-[510px]
                translate-x-[-45%] translate-y-[-45%]
                lg:translate-x-[-55%] lg:translate-y-[-50%]
                2xl:translate-x-[-60%] 2xl:translate-y-[-55%]
              "
            >
              <Image
                src="/grupoesfera+halo.png"
                alt="Grupo Esfera + Halo"
                fill
                style={{ objectFit: "contain" }}
                priority
              />
