...
export default function DataCards() {
  return (
    <div>
      {/* Título */}
      <div className="mb-24 text-center -mt-[140px] ml-[15px] max-md:ml-0">
      ...
      <div className="grid grid-cols-3 max-md:grid-cols-1 pt-[51px] w-fit mx-auto mb-[167px] justify-items-center max-lg:pt-[15px] max-md:gap-y-7">
        {/* Tarjeta 1 */}
        <div
          className="relative top-[40px] w-[427px] h-[218px] bg-cover bg-center text-white rounded-3xl overflow-hidden flex items-start justify-center max-xl:mt-3 max-xl:w-[292px] max-xl:h-[207px] max-lg:max-w-[230px] max-lg:h-[215px] max-md:max-w-[292px] max-md:top-0 max-md:mt-0"
        ...
        {/* Tarjeta 2 */}
        <div
          className="relative top-[40px] left-1 w-[427px] h-[218px]  bg-cover bg-center text-white rounded-[28px] overflow-hidden flex items-start justify-center  max-xl:w-[292px] max-xl:h-[228px] max-lg:max-w-[230px] max-lg:h-[240px] max-md:max-w-[292px] max-md:top-0 max-md:left-0"
          style={{ backgroundImage: "url('/gradiente-desktop.png')" }}
        >
        ...
        {/* Tarjeta 3 */}
        <div
          className="bg-cover bg-center w-[427px] h-[303px] text-white rounded-[29px] overflow-hidden flex items-start justify-center  ml-[22px] max-xl:w-[292px] max-xl:mt-3 max-xl:h-[280px] max-lg:max-w-[230px] max-lg:h-[340px] max-md:max-w-[292px] max-md:ml-0 max-md:mt-0"
          style={{ backgroundImage: "url('/gradiente-desktop.png')" }}
        >
          <p className="text-[20px] leading-[28px] text-left py-10 max-w-[351px] max-xl:max-w-[259px] mx-auto max-xl:text-[18px] max-xl:leading-[25px] max-xl:pl-2 max-xl:py-7 max-lg:text-[16px] max-lg:max-w-[200px] max-lg:pt-5 ">
