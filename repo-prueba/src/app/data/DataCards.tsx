  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 pt-[51px] w-fit mx-auto mb-[167px] justify-items-center max-lg:pt-[15px]">
        {/* Tarjeta 1 */}
        <div
          className="relative top-[40px] w-[427px] h-[218px] bg-cover bg-center text-white rounded-3xl overflow-hidden flex items-start justify-center max-xl:mt-3 max-xl:w-[292px] max-xl:h-[207px] max-lg:max-w-[230px] max-lg:h-[215px] "
        ...
        {/* Tarjeta 2 */}
        <div
          className="relative top-[40px] left-1 w-[427px] h-[218px]  bg-cover bg-center text-white rounded-[28px] overflow-hidden flex items-start justify-center  max-xl:w-[292px] max-xl:h-[228px] max-lg:max-w-[230px] max-lg:h-[240px]"
          style={{ backgroundImage: "url('/gradiente-desktop.png')" }}
        >
        ...
        {/* Tarjeta 3 */}
        <div
          className="bg-cover bg-center w-[427px] h-[303px] text-white rounded-[29px] overflow-hidden flex items-start justify-center  ml-[22px] max-xl:w-[292px] max-xl:mt-3 max-xl:h-[280px] max-lg:max-w-[230px] max-lg:h-[340px]"
          style={{ backgroundImage: "url('/gradiente-desktop.png')" }}
        >
