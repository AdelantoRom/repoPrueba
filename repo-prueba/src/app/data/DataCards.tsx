  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 pt-[51px] w-fit mx-auto mb-[167px] justify-items-center max-lg:pt-[15px]">
        {/* Tarjeta 1 */}
        <div
          className="relative top-[30px] w-[427px]  bg-cover bg-center text-white rounded-3xl overflow-hidden flex items-start justify-center max-xl:w-[292px] max-lg:max-w-[230px] max-lg:h-[220px]"
        ...
        {/* Tarjeta 3 */}
        <div
          className="bg-cover bg-center w-[427px] text-white rounded-[29px] overflow-hidden flex items-start justify-center  ml-[22px] mt-[7px] max-xl:w-[292px] max-lg:max-w-[230px]"
