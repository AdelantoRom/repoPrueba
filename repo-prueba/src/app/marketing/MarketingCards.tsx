  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 max-md:grid-cols-1 pt-[51px] w-fit mx-auto mb-[167px] justify-items-center max-lg:pt-[15px] max-md:gap-y-7 max-sm:mb-[80px]">
        ...
        >
          <p className="text-[20px] leading-[28px] text-left -ml-[6px] py-10 max-w-[351px] max-xl:max-w-[239px] max-xl:text-[18px] max-xl:leading-[25px] max-xl:py-7 max-lg:text-[16px] max-lg:max-w-[200px] max-lg:pl-2 max-lg:pt-5 max-md:max-w-[239px] max-md:ml-2max-md:max-w-[239px] max-md:ml-2 max-md:pl-0">
