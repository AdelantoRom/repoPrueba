  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 max-md:grid-cols-1 pt-[51px] w-fit mx-auto mb-[167px] justify-items-center max-lg:pt-[15px] max-md:gap-y-7">
        ...
        {/* Tarjeta 2 */}
        <div
          className="relative top-[30px] left-1 w-[427px] h-[218px] bg-cover bg-center text-white rounded-[28px] overflow-hidden flex items-start justify-center max-xl:w-[302px] max-xl:h-[228px] max-lg:max-w-[230px] max-lg:h-[215px] max-lg:mt-2 max-md:max-w-[292px] max-md:top-0 max-md:left-0 max-md:mt-0"
          style={{ backgroundImage: "url('/gradiente-desktop.png')" }}
        >
        ...
        {/* Tarjeta 3 */}
        <div
          className= "bg-cover bg-center w-[427px] h-[218px] text-white rounded-[29px] overflow-hidden flex items-start justify-center  ml-[22px] mt-[30px] max-xl:w-[292px]  max-xl:mt-[39px] max-xl:h-[207px] max-lg:max-w-[230px] max-lg:h-[236px] max-md:max-w-[292px] max-md:mt-0 max-md:ml-0"
          style={{ backgroundImage: "url('/gradiente-desktop.png')" }}
        >
