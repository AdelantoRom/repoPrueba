  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 max-md:grid-cols-1 pt-[51px] w-fit mx-auto mb-[167px] justify-items-center max-lg:pt-[15px] max-md:gap-y-7">
        ...
        <div
          className="relative top-[40px] w-[427px] h-[218px] bg-cover bg-center text-white rounded-3xl overflow-hidden flex items-start justify-center max-xl:h-[207px] pt-6 max-xl:w-[292px] max-lg:max-w-[230px] max-lg:h-[219px] max-lg:mt-1 max-md:max-w-[292px] max-md:top-0"
