...
//           width={60}
//           height={60}
//           className="absolute top-[50px] left-[325px]"
//         />
//       </div>
...
//       {/* Formulario embebido */}
//       <div className="relative z-10 mt-[700px] flex ml-[140px] gap-[60px]">
//         {/* Columna izquierda */}
//         <div>
//           <h3 className="text-[#D81FB9] text-[60px] w-[351px] font-normal leading-[60px] mt-[30px]">
//             Contáctanos
//           </h3>
...
//   return (
//     <section
//       className="relative w-full h-[3218px] bg-cover bg-center flex flex-col items-center justify-start"
//       style={{ backgroundImage: "url('/Gradiente-Home-5.png')" }}
//     >
//       {/* Título principal */}
//       <div className="mt-[260px] w-[1393px] h-[221px] flex flex-col items-center justify-center">
...
//     width={50}
//     height={50}
//     className="absolute top-[810px] left-[680px]" 
//     />
//       </div>

//       {/* Esfera pequeña */}
// <div className="absolute top-[710px] left-[1400px]">
//   <Image
//     src="/Trama-esfera-fucsia.png"
//     alt="Trama fucsia pequeña"
//     width={275}
...
// {/* Esfera grande */}
// <div className="absolute top-[940px] left-[50px]">
//   <Image
//     src="/Trama-esfera-fucsia.png"
//     alt="Trama fucsia grande"
//     width={503}
