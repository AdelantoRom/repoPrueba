    ...
    return (
        <div className='text-black pt-[219px] h-[3845px] max-w-[1637px] mx-[290px] max-xl:mx-[140px]  max-lg:mx-[20px]'>
            ...
            <div className='text-[24px] flex flex-col gap-2 leading-[28px] max-xl:px-10'>
                ...
                <p className='pb-5'>La Agencia podrá establecer condiciones particulares (en adelante, las "Condiciones Particulares") para la contratación o utilización de determinados servicios o productos que se ofrezcan a través de Rombus, por tanto, el usuario también ha de leer atentamente las correspondientes Condiciones Particulares que podrán ser publicadas en el site o enviadas por correo electrónico o enlace de descarga.</p>
                ...
                <p className='pb-4'>Al utilizar este sitio web, aceptas cumplir con todas las leyes y regulaciones locales, estatales, nacionales e internacionales aplicables.</p>
                <p className='pb-5'>No podrás utilizar este sitio de manera que pueda dañar, desactivar, sobrecargar o deteriorar la funcionalidad del sitio o interferir con el uso de terceros.</p>
                <h2 className='pb-5 font-bold'>Contenido</h2>
                <p className='pb-4'>Todo el contenido proporcionado en este sitio, incluidos textos, gráficos, imágenes, logotipos, videos y audio, está protegido por derechos de autor y otras leyes de propiedad intelectual.
