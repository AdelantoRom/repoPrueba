    ...
    return (
        <div>
            <div className="w-full flex justify-center lg:ml-4 lg:translate-x-[8px] 2xl:ml-6 2xl:translate-x-[-64px] 2xl:mt-[-16px]">
                ...
                <div className="flex justify-center items-start max-sm:flex-col max-sm:items-center max-sm:gap-y-10 gap-x-4 lg:gap-x-46 2xl:gap-x-110 w-full lg:max-w-[900px] 2xl:max-w-[1343px]">
