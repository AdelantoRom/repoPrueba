...
export default function Adn() {
  return (
    ...
    pt-[40px] pb-[40px] min-h-auto lg:min-h-[1434px] 2xl:min-h-[1394px] lg:pt-[100px] 2xl:pt-[131px] lg:pb-0">
      ...
      {/* ¿Conectamos? */}
      <div className="mb-[65px] mt-[50px] sm:mb-[100px] lg:mt-[60px] 2xl:mt-[70px]">
...
//       {/* Títulos */}
//       <div className="text-center drop-shadow-[2px_2px_4px_rgba(0,0,0,0.5)] tracking-normal leading-[40px] mt-[40px] 
//       lg:leading-[70px] lg:mt-[60px] 2xl:leading-[120px] 2xl:mt-[64px]">
//         <h1 className="text-[40px] font-medium w-[336px] mx-auto 
//         lg:text-[70px] lg:w-[899px] 2xl:text-[64px] 2xl:leading-[64px] 2xl:w-[1219px] 2xl:font-bold">
//           Rombux/ADN:
...
//       {/* Botón Conócenos */}
//       <div className="mb-0 lg:mb-[20px] 2xl:mb-0 2xl:mt-5">
//         <Link href="/about_us">
//           <button
//             type="submit"
//             className="bg-[#D81FB9] text-white text-[24px] leading-[32px] font-semibold h-[48px] w-[192px] 
...
// {/* Esferas decorativas MOBILE */}
//   <div className="relative mb-[80px] top-[60px] sm:hidden overflow-visible">
  
//   {/* Esfera grande */}
//   <div className="relative w-[296px] h-[296px] translate-x-[-110px]">
//     <Image
//       src="/Trama esfera negra.png"
//       fill
//       alt=""
...
//   {/* Esfera chica */}
//   <div className="absolute right-[-80px] top-[-14px] w-[125px] h-[125px]">
//     <Image
//       src="/Trama esfera negra.png"
//       fill
//       alt=""
...
//       {/* ¿Conectamos? */}
//       <div className="mb-[40px] mt-[10px] sm:mb-[100px]">
//         <p className="text-[38px] font-normal leading-[38px] text-center w-[336px] drop-shadow-[2px_2px_4px_rgba(0,0,0,0.5)]
//           lg:text-[54px] lg:leading-[36px] lg:w-[376px] 
//           2xl:text-[48px] 2xl:leading-[48px] 2xl:w-[446px]">
//           ¿Conectamos?
...
//       {/* Botones interactivos MOBILE */}
//       <div className="w-[336px] h-[714px] flex flex-col items-center justify-between sm:hidden">
//         {/* Botón 1 */}
//         <div className="flex flex-col items-center">
//           <div className="w-[65px] h-[65px] mb-[8px] bg-gray-200 rounded-full"></div>
//           <p className="text-[18px] leading-[24px] font-medium text-center">Agenda una reunión</p>
//         </div>

//         {/* Botón 2 */}
//         <div className="flex flex-col items-center">
//           <div className="w-[64px] h-[65px] mb-[8px] bg-gray-200 rounded-full"></div>
//           <p className="text-[18px] leading-[24px] font-medium text-center">Mándanos un email</p>
//         </div>

//         {/* Botón 3 */}
//         <div className="flex flex-col items-center">
//           <div className="w-[64px] h-[65px] mb-[8px] bg-gray-200 rounded-full"></div>
//           <p className="text-[18px] leading-[24px] font-medium text-center">Chatéa con Romy, IA</p>
//         </div>
//       </div>

//       {/* Botones interactivos TABLET & DESKTOP */}
//       <div className="hidden sm:block lg:mb-[60px] 2xl:mb-[46px] 2xl:mt-20">
//         <Botones />
//       </div>
//     </div>
//   );
