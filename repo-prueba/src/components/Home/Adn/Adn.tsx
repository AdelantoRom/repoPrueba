    ...
    <div className="bg-[url('/gradiente1.png')] bg-no-repeat bg-cover w-full min-h-screen text-white flex flex-col items-center pt-[40px] 2xl:pt-[196px]">
      ...
      <div className="flex flex-col items-center gap-y-[56px] w-[336px] mt-10 mb-[40px] 
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="lg:w-[120px] 2xl:w-[140px] text-center">
            <p className="text-white text-[18px] font-medium leading-[24px] 
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="mt-4 lg:w-[120px] 2xl:w-[132px] text-center">
            <p className="text-white text-[18px] font-medium leading-[24px] 
              lg:text-[20px] 2xl:text-[24px]">
              Envíanos<br />un mensaje
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="mt-4 lg:w-[160px] 2xl:w-[203px] text-center">
            <p className="text-white text-[18px] font-medium leading-[24px] 
              lg:text-[20px] 2xl:text-[24px]">
              Chatea con Romy,<br />nuestro agente virtual
            </p>
          </div>
        </div>
