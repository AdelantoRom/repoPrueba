    ...
    <div className="flex ml-[140px] mt-[100px] gap-[60px]">
      ...
      <div>
        ...
        <form className="mt-[40px] flex flex-col space-y-6 pb-[86px]">
          ...
          <button
            type="submit"
            className="bg-[#D81FB9] text-white text-[32px] font-bold h-[78px] w-[306px] rounded-[50px] mt-[12px] mb-[40px]"
          >
            Enviar
          </button>
        </form>
...
//           <button
//             type="submit"
//             className="bg-[#D81FB9] text-white text-[32px] font-bold h-[78px] w-[306px] rounded-[50px] mt-[12px] mb-[86px]"
//           >
//             Enviar
//           </button>
//         </form>
