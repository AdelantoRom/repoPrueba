...
export default function Formulario() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // si hay errores, no envío nada
    if (Object.keys(newErrors).length > 0) return;

    const data = { nombre, apellido, email, telefono, empresa, mensaje, area_de_servicio: serviciosSeleccionados };
  ...
  return (
    <div className="flex flex-col items-center pt-[115px] gap-[40px] lg:flex-row lg:items-start lg:ml-[60px] lg:pt-[100px] lg:gap-[60px] 2xl:ml-[290px] 2xl:pt-[192px]">
      {/* Columna izquierda */}
      ...
      <div className="relative mr-100 -translate-x-38 mt-37 mr-5 w-[660px] custom-form max-2xl:-translate-x-30 max-xl:w-[350px] max-xl:-translate-x-32 max-xl:translate-y-10 max-lg:hidden">
        <div className="w-[660px]">
          <Image src="/grupoesfera+halo.png" alt="Grupo Formulario" width={800} height={800} className="absolute" />
        </div>
