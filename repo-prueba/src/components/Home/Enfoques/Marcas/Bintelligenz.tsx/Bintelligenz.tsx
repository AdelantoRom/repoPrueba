            ...
            <div className="bg-white w-[1382px] rounded-3xl h-[828px] p-10 relative flex max-2xl:w-[1000px] max-2xl:h-[657px] max-2xl:p-7 max-xl:w-[950px] max-xl:h-[550px]">
                ...
                <div className=' w-[650px] mx-4 max-xl:w-[450px]'>
                    <div className='w-[603px] h-[579px] flex flex-col justify-around max-xl:w-[450px] max-2xl:w-[450px] max-2xl:justify-start'>
                        ...
                        <h1 className="text-[36px] font-semibold mb-4 leading-[36px] max-2xl:text-[30px] max-xl:text-[24px] max-2xl:mb-3 max-xl:mb-5">Bintelligenz (antes y después)</h1>
                        <p className="mb-1 text-[20px] font-light leading-[28px] max-2xl:text-[18px] max-2xl:mb-3 max-xl:mb-5">
                        ...
                        <p className="mb-1 text-[20px] font-light leading-[28px] max-2xl:text-[18px] max-2xl:mb-5">
                        ...
                        <p className="italic mb-25 text-[20px] font-medium leading-[28px] w-[300px] max-2xl:text-[18px] max-2xl:mb-5 max-xl:mt-5">
