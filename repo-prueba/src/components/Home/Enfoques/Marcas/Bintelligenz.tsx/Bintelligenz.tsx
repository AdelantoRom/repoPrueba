            ...
            <div
                ...
                <div className=' w-[650px] mx-4 max-xl:w-[450px]'>
                    <div className='w-[603px] ml-3 h-[579px] flex flex-col justify-around max-xl:w-[450px] max-2xl:w-[450px] max-2xl:justify-start'>
                        ...
                        <h1 className="text-[36px]  -mt-10 font-bold mb-4 leading-[36px] max-2xl:text-[30px] max-xl:text-[24px] max-2xl:mb-3 max-xl:mb-5">Bintelligenz (antes y después)</h1>
                        ...
                        <p className="mb-5 text-[16px] -mt-5 leading-[24px] max-2xl:text-[18px] max-2xl:mb-5">
                        ...
                        <p className="italic mb-20 text-[16px] font-medium leading-[28px] w-[300px] max-2xl:text-[18px] max-2xl:mb-5 max-xl:mt-5">
