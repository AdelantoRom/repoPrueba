            ...
            <div
                ...
                <div className=' w-[650px] mx-4 max-xl:w-[450px]'>
                    <div className='w-[603px] ml-3 h-[579px] flex flex-col justify-around max-xl:w-[450px] max-2xl:w-[450px] max-2xl:justify-start'>
                        ...
                        <h1 className="text-[36px] -mt-10 font-bold mb-4 leading-[36px] max-2xl:text-[30px] max-2xl:mt-3 max-xl:text-[24px] max-xl:leading-[64px] max-2xl:mb-0 max-xl:mt-[6px]">Bintelligenz (antes y después)</h1>
