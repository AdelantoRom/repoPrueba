            ...
            <div
                ...
                <div className=' w-[650px] mx-4 max-xl:w-[450px]'>
                    <div className='w-[610px] h-[579px] ml-4 flex flex-col justify-around max-xl:w-[450px] max-2xl:w-[450px] max-2xl:justify-start'>
                        ...
                        <p className=" text-[16px] -mt-10 leading-[24px]  max-2xl:mt-3 max-2xl:mb-3 max-xl:mb-0 max-xl:mt-1 max-xl:w-[440px]">
                        ...
                        <p className="italic text-[16px] font-medium mb-4 leading-[24px] max-2xl:mt-3 max-2xl:mb-5 max-xl:mt-1 max-xl:w-[435px]">
