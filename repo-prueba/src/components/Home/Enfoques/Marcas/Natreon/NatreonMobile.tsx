...
function NatreonMobile() {
    return (
        <div className='mt-25'>
            ...
            <div className=' text-black ml-3 h-[579px] flex flex-col justify-evenly  px-10 min-h-screen -mb-10'>
                <p className='text-[#747474] text-[16px] '>Caso</p>
                <h1 className="text-[24px] leading-[24px] font-semibold -mt-15">Un perfil de avanzada para alimentos más saludables</h1>
                <p className="text-[18px] font-light md:font-normal leading-[24px] -mt-15">
                ...
                <p className="text-[18px] italic font-medium leading-[24px] -mt-15">
