...
const PopupModalChile = ({ onClose }: Props) => {
    return (
        <div className="fixed inset-0 bg-gray-400/90 flex justify-center items-center z-50 ">
            <div className="bg-white w-[1382px] rounded-3xl h-[828px] p-10 relative flex max-2xl:w-[1000px] max-2xl:h-[657px] max-2xl:p-7 max-xl:h-[650px]">
                <button
                    onClick={onClose}
                ...
                <div className='w-[650px] mx-4 max-xl:w-[450px]'>
                    <div className='w-[600px] h-[679px] flex flex-col justify-around max-xl:w-[450px] max-2xl:w-[450px] max-2xl:justify-start '>
                        <Link href={"/"} className='text-[#747474] text-[22px] max-2xl:text-[19px] max-xl:text-[16px] max-2xl:mb-4 max-2xl:mt-7'>Caso</Link>
                        <h1 className="text-[36px] font-semibold mb-4 max-2xl:text-[30px] max-xl:text-[24px] max-2xl:mb-3">De Chile con Amor</h1>
                        <p className="mb-4 text-[20px] font-light max-2xl:text-[18px] max-2xl:mb-3">
                        ...
                        <p className="italic mb-4 text-[20px] font-medium max-2xl:text-[18px] max-2xl:mb-3">
                        ...
                        <div className="mb-4 text-[18px] max-2xl:text-[16px] max-2xl:mb-5">
                        ...
                        <Image src="/superpollo.png" alt="Logo Super Pollo" width={141} height={95} className='-mb-12 max-2xl:w-[100px]' />
                    </div>
                </div>
                <div className="relative flex content-center w-[606px] h-[679px] mt-8">
                    <Image
                        ...
                        width={606}
                        height={680}
                        className="rounded-3xl shadow-xl max-2xl:h-[550px]"
                    />
                </div>
            </div>
        </div>
