...
<div className="relative w-[440px] h-[440px] lg:w-[540px] lg:h-[540px] 2xl:w-[1005px] 2xl:h-[1005px] translate-y-[-24px] lg:-translate-x-6 lg:-translate-y-26 
2xl:-translate-x-18 2xl:-translate-y-42">
    ...
    ">
      ...
      {/* Texto container para que el orden funcione */}
<div className="flex flex-col order-2 lg:order-1 
  -mt-8 lg:mt-8
  pl-6 lg:pl-0 
  lg:space-y-12 2xl:space-y-12 
  2xl:mt-[10px] 2xl:-ml-[5px]">


        {/* Subtítulo */}
        <div className="order-2 lg:order-1">
          <h2 className="
            text-[20px] leading-[30px] font-medium mb-[30px]
            lg:text-[32px] lg:leading-[30px] lg:mb-[12px] lg:font-normal
            2xl:text-[32px] 2xl:leading-[36px] 2xl:mb-[4px] 2xl:font-normal
          ">
