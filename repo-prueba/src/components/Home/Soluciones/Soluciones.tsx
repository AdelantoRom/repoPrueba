...
export default function Soluciones() {
  return (
    <main className="relative w-full min-h-screen text-white overflow-hidden">
      ...
      {/* Contenido */}
      <div className="relative pt-[50px] pb-[20px] lg:pt-[150px] lg:pb-[10px] 2xl:pt-[197px] 2xl:pb-[40px]">
        <div className="lg:pl-26 lg:pr-8 2xl:pl-74 2xl:pr-10">
...
<div className="flex flex-col lg:hidden items-end text-right px-6 mt-[104px]">
  <h2 className="text-[40px] leading-[40px] font-normal mb-6">
  ...
  <TransformacionDigital />
          ...
          <div className="hidden lg:flex flex-row justify-start items-start 
                          ...
                          2xl:mt-28 2xl:py-20 2xl:gap-x-36">
            
            <div className="flex justify-start lg:order-1 2xl:order-2 lg:mt-4 2xl:mt-12 lg:translate-x-8 2xl:translate-x-0">
              <h2 className="relative z-10 text-right drop-shadow-[2px_2px_4px_rgba(0,0,0,0.5)]
                             font-normal
                             lg:text-[70px] lg:leading-[70px] lg:max-w-[487px]
                             2xl:text-[102px] 2xl:leading-[110px] 2xl:max-w-[630px]">
