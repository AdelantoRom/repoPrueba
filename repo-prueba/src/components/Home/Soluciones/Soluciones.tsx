...
{/* MOBILE: título + texto debajo */}
          <div className="flex  max-md:flex-col-reverse justify-between md:mx-16 lg:hidden items-end text-right px-6 mr-3 max-md:mt-[450px] mb-10 max-sm:mt-117">
          ...
          <div className="hidden lg:flex flex-row justify-start items-start 
                          lg:mt-16 lg:py-16 lg:gap-x-0
                          2xl:mt-28 2xl:py-20 ">
            
            <div className="w-full max-2xl:mr-6 flex justify-end lg:order-1 2xl:order-2 lg:mt-4 2xl:mt-12 2xl:translate-x-0 xl:mr-22 2xl:mr-60">
