...
//   <div className="max-w-[393px] mx-auto">
//     <div className="flex justify-between items-center mb-2">
//       <Link href="/" className="ml-4">  {/* <- Mueve Rombux a la derecha */}
//         <Image
//           src="/Logo Rombux fucsia footer.png"
//           alt="Logo Footer Mobile"
//           width={171}
...
//         />
//       </Link>
//       <div className="mr-4">  {/* <- Mueve logoin a la izquierda */}
//         <Image
//           src="/logoin.png"
//           alt="Logo IN Mobile"
//           width={30}
...
//     <div
//       className="w-[336px] text-[10px] text-white mt-12 leading-tight ml-4"  {/* <- Mueve <p> a la derecha */}
//       style={{ lineHeight: "12px" }}
//     >
//       <p>
//         © 2024 Rombus Global SAS. Todos los derechos reservados.{" "}
