...
export default function Thank() {
    return (
        <div className="relative w-full h-[676px] flex flex-col max-md:justify-start items-center justify-center text-white overflow-hidden">
            ...
            <div className="absolute -bottom-20 -left-40 z-0 w-[30vw] max-w-[541px] h-[30vw] max-h-[541px] max-md:bottom-60 max-md:-left-10  max-md:w-[60vw] max-md:h-[60vw] max-sm:w-[70vw] max-sm:h-[70vw] max-sm:-left-20 max-sm:bottom-70 ">
                <Image
            ...
            <div className=" text-center px-4 max-md:mt-60">
